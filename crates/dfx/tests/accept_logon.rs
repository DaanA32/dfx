...
use dfx::{
    ...
    logging::{FileLogFactory, PrintlnLogFactory},
    message::DefaultMessageFactory,
    message_store::{DefaultStoreFactory, FileStoreFactory},
...
pub fn test_accept() {
    ...
    let runner_thread =
        runner::create_thread(steps, 40000, "tests/definitions/server/accept_logon.def");
